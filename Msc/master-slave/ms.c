...
*/
 ...
 /**
 * Compare function to use at sort algorithm
 * @param a a constant pointer.
 * @param b a constant pointer.
 * @return diference betwen two elements
 */
