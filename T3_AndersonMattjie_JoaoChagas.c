...
/*
-OBSERVAÇÕES
+Transformar o saco de tarefas em contiguo visto que será necessário pegar as 8 linhas e colocar em um buffer para posteriormente enviar para as theads.
